...
public class TrailRendererWith2DCollider : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        trail.GetComponent<Renderer>().material = GetComponent<SpriteRenderer>().material;
        trail.GetComponent<Renderer>().material.color = GetComponent<SpriteRenderer>().color;
        trail.tag = "trail";
